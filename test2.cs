// Dafny program test2.dfy compiled into C#
...
// Dafny 2.1.1.10209
// Command Line Options: /spillTargetCode:1 test2.dfy
// test2.dfy
...
namespace @__default {
  ...
  public partial class @A {
    ...
    public void @__ctor(BigInteger[][] @b)
    {
      var _this = this;
    TAIL_CALL_START: ;
      var _obj0 = _this;
  ...
  public partial class @__default {
    public static void @sub(BigInteger[][] @a)
    {
    TAIL_CALL_START: ;
      System.Console.Write(((@a)[(int)(new BigInteger(0))])[(int)(new BigInteger(0))]);
      BigInteger[][] @_17_b = (BigInteger[][])null;
      BigInteger[][] _rhs1 = @a;
      @_17_b = _rhs1;
      System.Console.Write(((@_17_b)[(int)(new BigInteger(0))])[(int)(new BigInteger(0))]);
    }
    public static void @Main()
    {
    TAIL_CALL_START: ;
      BigInteger[][] @_18_a = (BigInteger[][])null;
      var _nw0 = Dafny.ArrayHelpers.InitNewArray1<BigInteger[]>(new BigInteger[0], (new BigInteger(2)));
      @_18_a = _nw0;
      var _arr0 = @_18_a;
      var _index0 = new BigInteger(0);
      var _nw1 = new BigInteger[(int)(new BigInteger(2))];
      _arr0[(int)_index0] = _nw1;
      var _arr1 = (@_18_a)[(int)(new BigInteger(0))];
      var _index1 = new BigInteger(0);
      BigInteger _rhs2 = new BigInteger(42);
      _arr1[(int)_index1] = _rhs2;
      System.Console.Write(((@_18_a)[(int)(new BigInteger(0))])[(int)(new BigInteger(0))]);
      @__default.@sub(@_18_a);
      @A @_19_b = default(@A);
      var _nw2 = new @A();
      @_nw2.@__ctor(@_18_a);
